...
module SamlIdp
  class Request
    ...
    def valid?
      ...
      pp "service_provider: #{service_provider.to_json}"
    ...
    def service_provider
      ...
      pp "SamlIdp::Request#service_provider: #{ServiceProvider.new((service_provider_finder[issuer] || {}).merge(identifier: issuer))} -4"
